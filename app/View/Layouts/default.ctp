...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand navbar-dark bg-primary">
            ...
            <?= $this->Html->link('Administrativo', array('action' => '/'), array('class' => 'navbar-brand'))?>
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul id="submenu1" class="list-unstyled collapse">
                            <li><?php echo $this->Html->link(__('Criar Usuario'), array('controller' => 'users','action' => 'add'),array('field' => 'div')); ?></li>
                            <li><?= $this->Html->link('Ver usuarios', array('controller' => 'Users', 'action' => 'index')) ?></li>
